...
<nav class="py-2 h-full shadow-2xl bg-white">
    <ul class="w-15 mt-4 ml-4 md:grid gap-4">
        ...
        <li class="relative"><a href="/umkm" class=" {{ Request::is('umkm') ? 'active' : '' }} mr-8 block rounded-md py-2 font-bold md md:p-3 text-[#092F69] hover:bg-[#092F69]/25 active:bg-blue-400/70">Data UMKM</a></li>
