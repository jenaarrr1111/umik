<div class="relative block mb-4 w-min ml-auto shadow-md">
    ...
    <form action="{{ $path }}" class="flex gap-2">
        <input type="text" name="search" class="placeholder:text-slate-700 block border border-slate-300 rounded-lg py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Cari yang baru hari ini">
